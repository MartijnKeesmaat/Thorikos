...
function update(svg, spatialGrid) {
  ...
  svg.selectAll('rect').data(spatialGrid).transition(t).attr('fill', function (d) {
    return d.value ? "rgba(16, 115, 197, ".concat((0, _helpers.normalize)(d.value, 0, highestValue), ")") : '#fff';
...
},{"./gridCodes":"gridCodes.js","./draw-map":"draw-map.js"}],"draw-bar-chart.js":[function(require,module,exports) {
"use strict";
...
},{"./styles.scss":"styles.scss","./map":"map.js","./draw-bar-chart":"draw-bar-chart.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
