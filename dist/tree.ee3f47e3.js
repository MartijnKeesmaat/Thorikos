...
var root = d3.hierarchy(makeData()).sum(function (d) {
  return d.value;
}).sort(function (a, b) {
...
d3.interval(function (_) {
  console.log(makeData());
  root = d3.hierarchy(dummy).sum(function (d) {
    return d.value;
  }).sort(function (a, b) {
    return b.value - a.value;
  });
...
function draw(resizing) {
  ...
  rects.enter().append('rect').attr('class', 'rect').style('fill', function (d, i) {
    return "rgba(66, 142, 255, ".concat((0, _helpers.normalize)(d.value, 0, 5980), ")");
...
},{"./helpers":"helpers.js"}],"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tree.js"], null)
